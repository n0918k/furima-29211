class UserItem
  ...
  def save
    Order.create(number: number,house_number: house_number,prefecture_id: prefecture_id,city: city,address: address,phone_number: phone_number, item_id: item_id, user_id: user_id, price: price)
